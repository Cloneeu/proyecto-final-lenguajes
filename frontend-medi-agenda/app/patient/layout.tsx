...
const NAV_ITEMS = [
  { href: "/patient", label: "Mis Citas", icon: CalendarIcon },
  { href: "/patient/expediente", label: "Expediente", icon: FileTextIcon },
  { href: "/patient/recetas", label: "Recetas", icon: FilePlusIcon },
]
