...
const NAV_ITEMS = [
  { href: "/dashboard/receptionist", label: "Resumen", icon: LayoutDashboardIcon },
  { href: "/dashboard/receptionist/pendientes", label: "Solicitudes Pendientes", icon: ClockIcon },
  { href: "/dashboard/receptionist/agenda", label: "Agenda de Citas", icon: CalendarDaysIcon },
]
